...
public class AmbitManager {
    ...
    private final static int AMBIT_2R   	= 0x19;   // 29
    ...
    public void exportLog( LogInfo logInfo, File exportDir, long currentProgress , long maxProgress ) throws UsbException, IOException
    {
        ...
        org.ambit.command.LogSampleCommandExecutor logSampleCommand = new org.ambit.command.LogSampleCommandExecutor();

        org.ambit.data.SampleReadInfo sampleReadInfo = logInfo.getFirstSampleReadInfo();
        ...
        while ( sampleReadInfo.getLastSampleRead() < logInfo.getSampleCount() ) {
            ...
            org.ambit.data.LogSample logSample = logSampleCommand.executeCommand(ambitDevice);
        ...
        org.ambit.export.GpxExportVisitor gpxVisitor = new org.ambit.export.GpxExportVisitor(exportDir, logInfo.getCompleteName() + ".gpx");
        gpxVisitor.init();
